...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(default='Jogo', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('entregue', 'Entregue'), ('cancelado', 'Cancelado'), ('aguardando pagamento', 'Aguardando pagamento'), ('carrinho', 'Carrinho')], default='carrinho', max_length=50)),
